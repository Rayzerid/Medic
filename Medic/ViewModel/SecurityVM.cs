...
{
    public class SecurityVM : ViewModelBase
    {
        public SecurityVM()
        {
        ...
        private async void ButtonClick(object sender)
        {
            ...
            switch (Password.Length)
            {
                ...
                case 4:
                    ...
                    await AppShell.Current.GoToAsync($"//{nameof(RgistrationView)}");
                    break;
            }
        }
        ...
        public Color FirstEntryBackColor
        {
            ...
            set { _firstEntryBackColor = value; OnPropertyChanged("FirstEntryBackColor"); }
        }
        ...
        public Color SecondEntryBackColor
        {
            ...
            set { _secondEntryBackColor = value; OnPropertyChanged("SecondEntryBackColor"); }
        }
        ...
        public Color ThirdEntryBackColor
        {
            ...
            set { _thirdEntryBackColor = value; OnPropertyChanged("ThirdEntryBackColor"); }
        }
        ...
        public Color FourthEntryBackColor
        {
            ...
            set { _fourthEntryBackColor = value; OnPropertyChanged("FourthEntryBackColor"); }
        }
        ...
        public bool BtnIsEnabled
        {
            ...
            set { _btnIsEnabled = value; OnPropertyChanged("BtnIsEnabled"); }
        }

        private bool _btnEraseIsEnabled = false;
        public bool BtnEraseIsEnabled
        {
            get { return Password.Length == 0 ? false : true; }
            set { _btnIsEnabled = value; OnPropertyChanged("BtnEraseIsEnabled"); }
        }
    }
}
